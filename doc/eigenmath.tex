...
Returns the error function of $x$ if $x$ is a real number.
...
Returns the complementary error function of $x$ if $x$ is a real number.
...
\subsection*{while($a,b,c,\ldots$)}

While $a$ is true (nonzero), evaluate $b$, $c$, etc., in a loop.
