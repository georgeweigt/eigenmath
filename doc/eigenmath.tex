...
Function \verb$dot$ returns the inner product of vectors, matrices,
...
The argument list can be extended, for example, \verb$dot(A,B,C)$.
Arguments are evaluated from right to left
for improved efficiency when the last argument is a vector.
