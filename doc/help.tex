...
\bigskip
\noindent
For floating point $n$, results are generally inexact for values greater than $2^{53}$.
For floating point $n$ with a fractional part (non-integer), a rational approximation of $n$ is factored.
