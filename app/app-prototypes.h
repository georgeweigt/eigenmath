...
void emit_draw_codes(double x, double y, struct atom *p);
...
void emit_update_subexpr(int t);
void emit_update_subscript(int t);
void emit_update_superscript(int t);
void emit_update_table(int n, int m);
void emit_vector(struct atom *p);
void init_font(void);
CTFontRef get_font_ref(int font);
int get_ascent(int font);
double get_char_height(int font);
int get_descent(int font);
double get_char_depth(int font);
int get_xheight(int font);
int get_width(int font, int c);
...
void * run1(void *s);
CFStringRef get_char_name(int c);
