...
void infixform_denom(struct atom *p, int d);
void infixform_factor(struct atom *p);
void print_index_function(struct atom *p);
void infixform_factorial_function(struct atom *p);
void infixform_tensor(struct atom *p);
void infixform_tensor_inner(struct atom *p, int j, int *k);
void infixform_function_definition(struct atom *p);
void infixform_arg_list(struct atom *p);
void infixform_multiply_sign(void);
int is_denominator(struct atom *p);
int any_denominators(struct atom *p);
void infixform_number(struct atom *p);
