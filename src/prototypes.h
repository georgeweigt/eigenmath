...
void rotate_check(int control, int target);
void rotate_h(int control, int target);
void rotate_p(int control, int target);
void rotate_x(int control, int target);
void rotate_y(int control, int target);
void rotate_z(int control, int target);
void run(char *s);
void init(void);
void prep(void);
