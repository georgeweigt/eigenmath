...
void latex_derivative_function(struct atom *p);
void latex_factorial_function(struct atom *p);
void latex_index_function(struct atom *p);
...
void mml_derivative_function(struct atom *p);
void mml_factorial_function(struct atom *p);
void mml_index_function(struct atom *p);
