...
struct atom * pop_binding(struct atom *p);
struct atom * pop_arglist(struct atom *p);
void push_binding(struct atom *p, struct atom *b);
void push_arglist(struct atom *p, struct atom *a);
