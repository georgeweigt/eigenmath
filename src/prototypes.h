...
void push_coeffs(void);
void rationalize_coeffs(int h);
int factorpoly_divisor(int h);
void factorpoly_divide(int h, struct atom *A, struct atom *B);
void evalpoly(int h, int n, struct atom *Q);
void push_divisors(void);
